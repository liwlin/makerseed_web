...
| Screen 3 / 7 / 9: MakerSeed · 机构介绍 | `pages/student/membership/` is the tab page and implements the design's `机构介绍` page with in-page `实力 / 师资研发` switching. Old member-center content is not used in this tab. |
...
| Screen 7: 机构介绍 · 实力 | `pages/student/membership/` and the secondary `pages/student/org-strength/` copy implement the screenshot layout: subnav, dark company header, authority licenses, awards, campus photos and partner schools. |
